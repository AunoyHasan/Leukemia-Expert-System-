...
@section('title', 'Radiological Good Condition')
...
<div>
    <div class="card">
        <div class="card-header" style="text-align: center; background-color:aquamarine"> Biochemistry Testing Result : Good Condition</div>
